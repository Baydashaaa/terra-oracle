  ...
  pg.innerHTML = `
    <div style="text-align:center;margin-bottom:36px;">
      ...
      <h1 style="font-family:'Rajdhani',sans-serif;font-weight:800;font-size:clamp(26px,4vw,38px);color:#fff;margin-bottom:10px;display:flex;align-items:center;justify-content:center;">
        ${tab === 'leaderboard' ? '<span style="display:inline-flex;align-items:center;gap:10px;"><img src="assets/icons/Leaderboard.png" style="width:60px;height:60px;flex-shrink:0;display:block;mix-blend-mode:lighten;"><span style="color:#fff;font-size:clamp(26px,4vw,38px);font-weight:800;margin-top:8px;">Leaderboard</span></span>' : tab === 'stats' ? '<span style="display:inline-flex;align-items:center;gap:10px;"><img src="assets/icons/Stats.png" style="width:60px;height:60px;flex-shrink:0;display:block;mix-blend-mode:screen;"><span style="color:#fff;font-size:clamp(26px,4vw,38px);font-weight:800;margin-top:8px;">Your Stats</span></span>' : '📖 How it Works'}
      </h1>
    ...
    <div style="display:flex;gap:8px;margin-bottom:28px;justify-content:center;flex-wrap:wrap;">
      <button onclick="showRepPage('leaderboard')" style="
        ...
        <img src="assets/icons/Leaderboard.png" style="width:24px;height:24px;vertical-align:middle;margin-right:4px;mix-blend-mode:lighten;"> Leaderboard
      </button>
      <button onclick="showRepPage('stats')" style="
        ...
        font-family:'Exo 2',sans-serif;font-size:11px;font-weight:700;letter-spacing:0.08em;
        padding:8px 20px;border-radius:8px;cursor:pointer;transition:all 0.2s;">
        <img src="assets/icons/Stats.png" style="width:24px;height:24px;vertical-align:middle;margin-right:4px;mix-blend-mode:screen;"> Your Stats
      </button>
