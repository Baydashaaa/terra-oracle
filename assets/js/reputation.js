    ...
    <div style="background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:24px;margin-bottom:16px;">
      ...
      <div id="stats-activity-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:10px;">
          ...
          <div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;padding:16px;
            ...
            <div>
              <div style="font-size:11px;color:var(--muted);margin-bottom:4px;" id="stats-label-${k}">
                ${{questions:'<img class="act-ic" src="assets/img/icons/ask.webp" alt="" width="128" height="128" loading="lazy"> Questions',answers:'<img class="act-ic" src="assets/img/icons/chat.webp" alt="" width="128" height="128" loading="lazy"> Answers',upvotes:'<img class="act-ic" src="assets/img/icons/p-upvotes.webp" alt="" width="128" height="128" loading="lazy"> Upvotes received',chat:'<img class="act-ic" src="assets/img/icons/p-messages.webp" alt="" width="128" height="128" loading="lazy"> Chat messages'}[k]}
              </div>
        ...
        <div style="background:var(--surface2);border:1px solid rgba(255,136,68,0.25);border-radius:10px;padding:16px;
          display:flex;align-items:center;justify-content:space-between;">
          <div>
            <div style="font-size:11px;color:var(--muted);margin-bottom:4px;"><img class="act-ic" src="assets/img/icons/draw.webp" alt="" width="128" height="128" loading="lazy"> Oracle Draw mints</div>
