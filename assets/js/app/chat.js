...
// Карточка участника живёт в assets/js/page/wallet-profile.js (window.OracleProfile).
// openUserProfile оставлен тонкой обёрткой: его вызывают аватары и ники в чате.
window.openUserProfile = function (wallet) {
  if (window.OracleProfile) window.OracleProfile.open(wallet);
};
