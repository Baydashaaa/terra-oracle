...
const RANKS = [
  ...
  {
    name: 'ANALYST',    icon: '🔮', minScore: 800,
  ...
  {
    name: 'ORACLE',     icon: '⚡', minScore: 2000,
  ...
  {
    name: 'ARCHON',     icon: '🔥', minScore: 5000,
  ...
  {
    name: 'ASCENDED',   icon: '✦',  minScore: 12000,
